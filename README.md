...
const App = () => {
  ...
  return (
    <div>
      ...
      <CountdownTimer
        initialTime={150} // Starts with 2 minutes 30 seconds
        ref={(ref) => (timerRef = ref)} // Expose timer functions
      />
      <div>
...
Deliverables:
A fully functional CountdownTimer component with internal controls and support for external control via props or a ref.
An explanation of how you exposed external control logic (e.g., using React.forwardRef or context).